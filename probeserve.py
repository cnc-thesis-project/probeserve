...
DEFAULT_MWDB_URL = "https://SET_THIS"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scan-interval", help="Scan interval.", type=int, default=DEFAULT_SCAN_INTERVAL_SECONDS)
    ...
    mwdb = mwdblib.MWDB(api_url=args.mwdb_url, api_key=secret,
                        retry_on_downtime=True, max_downtime_retries=10, downtime_timeout=20)
